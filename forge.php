                                ...
                                <div class="row">
                                    <div class="col text-left">
                                        <p class="text-white">
                                            ...
                                            <br />
                                            <b>Forging:</b> To make forging a bit more like actually mining for things like gold and silver, the forge rate isn't constant. Instead, the cost to forge increases based on how recently the last forge occurred. You may try forging tokens once per hour, up to the current per user forge limit. <b>The forge process is competative. If someone forges right before you, the cost per token may be significantly higher than expected and the number of tokens you receive may be significnatly less than expected. <br />
                                            <br />
