...
<html lang="en">
    <head>
        <title>Charity Support | World Builder</title>
        ...
        <meta name="description" content="World Builder Charity Support - OdettePH Relief">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col text-left">
                            <h1 class="text-white">Charity Support: Super Typhoon Rai/Odette Recovery</h1>
                            <p class="text-success">Supporting cleanup efforts for those in the Philippines affected by Super Typhoon Rai/Odette.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card glassPanel border-light rcAll">
                        <div class="card-header glassPanel text-white rcTop">Background</div>
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col text-left">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col text-center">
                                      <p class="text-white">
                                      We will donate 100 USD per 1 million $PHC minted and for each new smith registered, up to $5,000 to Philippines charities supporting the recovery from Super Typhoon Rai/Odette. The marked supply is 25,354,494 $PHC and 25 smiths. No minting or registrations will be counted for donations past 11:59PM EST on 1/31/21.
                                     </p>
                                      <hr/>
                                      <p class="text-white">
